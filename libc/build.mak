...
libc += network/accept4.o
libc += network/accept.o
libc += network/bind.o
libc += network/connect.o
libc += network/listen.o
libc += network/recv.o
libc += network/recvfrom.o
libc += network/recvmsg.o
libc += network/send.o
libc += network/sendmsg.o
libc += network/sendto.o
libc += network/getsockopt.o
libc += network/setsockopt.o
libc += network/shutdown.o
libc += network/socket.o
