//
// Instructions: run this test with 2 vcpus
//
#include <cstdlib>
#include <ctime>
#include <sched.hh>
#include <debug.hh>
#include <include/lockfree/ring.hh>

//
// Create 4 threads on different CPUs which perform concurrent push/pop
//
class test_concurrent_push_pop {
public:
...
private:
    ...
    wait_ring_spsc<int, 4096> _ring;
    // process 1 billion elements
    const u64 elements_to_process = 500000000;
